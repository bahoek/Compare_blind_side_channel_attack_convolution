...
MODEL_PATH = r"./models/kyber_ASC_open.pth"
EPS_SAVE_PATH = r"./data/guessing_entropy_ASC_open.eps"

REAL_KEY = 17                  

# =========================================================================
# 🧠 2. Modern 1D ASCAD Backbone Architecture (256-Class Mapping)
# =========================================================================
class ASCAD(nn.Module):
    def __init__(self, num_classes=256):
        ...
        self.feature_extractor = nn.Sequential(
            nn.Conv1d(1, 64, kernel_size=65, stride=2, padding=32, bias=False),  
            nn.BatchNorm1d(64),
            nn.ReLU(),
            nn.Dropout(0.3),
...
if __name__ == "__main__":
    ...
    # Internal Legend Placement Optimization
    plt.legend(loc='center right', framealpha=0.4, edgecolor='none', facecolor='white')
    plt.tight_layout()
